<template>
	<b-row>
		<b-col cols="12" class="d-none d-sm-block">
			<h1 class="text-center mt-4 fs-5">Sign in</h1>	
		</b-col>
		<b-col cols="12" lg="8" class="mx-auto mt-3 mt-sm-2">
			<GoolgeSigninButton @onSigninSuccess="redirectUser" />
		</b-col>
		<b-col cols="12" lg="8" class="mx-auto mt-2">
			<b-col cols="12" lg="12" class="mt-2">
				<FacebookSigninButton @onSigninSuccess="redirectUser"/>
			</b-col>
		</b-col>
		<b-col cols="12" lg="8" class="mx-auto mt-2">
		...
		<b-col cols="12" class="mt-2 mt-sm-0" >
			<h1 class="text-center fs-5">Sign in with your e-mail account</h1>	
		</b-col>
		...
		<b-col cols="12" class="text-center mt-3">
			<router-link to="signup" style="font-weight: bold; text-decoration: none;">If you don't have an account, create one here.</router-link>
		</b-col>
